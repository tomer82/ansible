...
$sysmonconfig_downloadlink = 'https://raw.githubusercontent.com/j91321/ansible-role-sysmon/master/files/swiftonsecurity-sysmonconfig.xml'
$sysmonconfig_file = 'swiftonsecurity-sysmonconfig.xml'
